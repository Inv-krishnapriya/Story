...
describe("Campaign updates ", () => {
  ...
  it("open industry modal 1", async () => {
    render(
      <AppTheme>
  ...
  it("open industry modal 1", async () => {
    ...
    const creationButton = screen.getByTestId(
      "campaign.creation.form.survey-creation"
    );
    await act(async () => {
    ...
    fireEvent.click(screen.getByText(i18n.t("campaign.creation.modal.yes")));
    await act(async () => {
      fireEvent.click(creationButton);
    });
  ...
  it("open industry remove", async () => {
    ...
    await act(async () => {
      fireEvent.click(
        screen.getByText(i18n.t("campaign.creation.modal.return"))
      );
    });

    //
  });
  it("hasInitialQuestion false", async () => {
    render(
      <AppTheme>
        <div id="main-container">
          <WrapperForm>
    ...
    const optionRemoveElements = screen.queryAllByTestId(
      "active-question-click"
    );
