...
describe("Campaign updates ", () => {
  ...
  it("open industry modal 1", async () => {
    ...
    const prefectureButton = screen.getByText(
      i18n.t("interview.section4.prefecture-button")
    );
    const professionButton = screen.getByText(
      i18n.t("interview.section4.profession-button")
    );
    fireEvent.click(prefectureButton);
    fireEvent.click(
      screen.getByText(i18n.t("campaign.creation.modal.submit-button"))
    );
    fireEvent.click(professionButton);
    fireEvent.click(
      screen.getByText(i18n.t("campaign.creation.modal.submit-button"))
    );
